...
def create_hf_bert_mlm(pretrained_model_name: str = 'bert-base-uncased',
    ...
    if use_pretrained:
        ...
        cfg = BertConfig(**remote_cfg.to_dict())    

        config = transformers.AutoConfig.from_pretrained(pretrained_model_name, **model_config, trust_remote_code=True)
        assert transformers.AutoModelForMaskedLM.from_config is not None, 'AutoModelForMaskedLM has from_config method'
        model = transformers.AutoModelForMaskedLM.from_config(config=cfg, trust_remote_code=True)
        #model = transformers.AutoModelForMaskedLM.from_pretrained(pretrained_model_name_or_path=pretrained_model_name, trust_remote_code=True) 
...
def create_hf_bert_classification(
    ...
    if use_pretrained:
        ...
        config = transformers.AutoConfig.from_pretrained(
            pretrained_model_name, **model_config) #, trust_remote_code=False
